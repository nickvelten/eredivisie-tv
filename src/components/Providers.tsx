      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {providers.map((provider) => (
          <a
            ...
            className="group flex flex-col justify-between rounded-xl bg-white p-5 shadow-sm ring-1 ring-black/5 transition-all hover:shadow-md hover:ring-accent/20"
          >
            <div>
